package will.tw.airquality.accuweather.api;
...
public class AccuWeatherApi {
    ...
    public static Observable<AccuweatherReport> findReportByLocaiotnKey(String type) {
    ...
    private interface UvService {
        ...
        Observable<AccuweatherReport> findReport(@Path("location") String locaiotn, @QueryMap Map<String, String> parameters );
    }
}
